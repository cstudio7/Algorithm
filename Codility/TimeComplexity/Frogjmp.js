...
//     The frog can cross only when leaves appear at every position across the river
//     from 1 to X (that is, we want to find the earliest moment when all the positions from
