...
// lack of discipline,
// the professor decides to cancel class if fewer than some number of students
// are present when class starts. Arrival times go from on time () to arrived late ().
//
