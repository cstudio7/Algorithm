...
// with one parking space per meter. Many cars are currently parked,
// and you want to shelter from the rain by building a roof.
...
// k: 3
// Output: 9
// Explanation: You can build a roof with a length of 9 to cover all parking spaces from the 2nd to the 10th,
// so you can cover 3 cars at the 2nd, 10th, and 8th positions.
// There is no shorter one that can cover the roof of 3 cars, so the answer is 9
//
// Precautions
// 1 <= n <= 10^5
// 1 <= k <= n
